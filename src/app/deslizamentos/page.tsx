  ...
  const loadDeslizamentos = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setDeslizamentos(data)
      }
    } catch (error) {
      console.error("Erro ao carregar deslizamentos:", error)
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mt-12 bg-orange-50 rounded-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Faça login para registrar deslizamentos em sua região e ajudar outros moradores a se prepararem melhor.
          </p>
          <div className="space-x-4">
            ...
            <Link
              href="/register"
              className="bg-white text-orange-600 border border-orange-600 px-6 py-2 rounded-lg hover:bg-orange-50 inline-block"
            >
              Criar Conta
            </Link>
          </div>
